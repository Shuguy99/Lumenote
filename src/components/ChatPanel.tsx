...
export default function ChatPanel() {
  ...
  return (
    <div className="w-96 min-w-96 border-l border-gray-200 bg-white flex flex-col h-full">
      {/* Header */}
      ...
      {/* Error banner */}
      {error && (
        <div className="px-4 py-2 bg-red-50 text-red-600 text-xs border-b border-red-100 flex items-center justify-between gap-2">
      ...
      <div className="border-t border-gray-200 p-4">
        <div className="flex items-end gap-2 bg-gray-50 rounded-xl px-3 py-2 border border-gray-200 focus-within:border-blue-400 transition-colors">
          <textarea
            value={input}
            ...
            rows={1}
            className="flex-1 bg-transparent text-sm text-gray-800 outline-none resize-none min-h-5 max-h-32"
          />
          <button
            onClick={handleSend}
